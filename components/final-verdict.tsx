  ...
  return (
    <div className="grid gap-6">
      <Card className="border-none shadow-md">
        <CardHeader className="bg-gradient-to-r from-amber-500/10 to-orange-500/10 dark:from-amber-900/20 dark:to-orange-900/20 rounded-t-lg">
          <div className="flex items-center">
            <div className="bg-green-100 dark:bg-green-900/30 p-3 rounded-full mr-4">
              <CheckCircle className="h-6 w-6 text-green-600 dark:text-green-400" />
            </div>
            <div>
              <CardTitle className="text-2xl text-amber-700 dark:text-amber-300">{verdict.title}</CardTitle>
        ...
        <CardContent className="pt-6">
          <div className="grid gap-6">
            <div>
              <h3 className="text-lg font-semibold mb-4 flex items-center text-blue-700 dark:text-blue-300">
                <Info className="h-5 w-5 mr-2 text-blue-500" />
                Key Metrics for {bestAlgorithm.name}
              </h3>
              <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
                <div className="bg-gradient-to-br from-blue-50 to-blue-100 dark:from-blue-900/20 dark:to-blue-900/40 p-4 rounded-lg shadow-sm">
                  <div className="text-sm text-blue-600 dark:text-blue-300 font-medium">Total Execution Time</div>
                  <div className="text-2xl font-bold text-blue-700 dark:text-blue-200 mt-1">
                    {bestAlgorithm.totalExecutionTime.toFixed(2)}
                  </div>
                </div>
                <div className="bg-gradient-to-br from-purple-50 to-purple-100 dark:from-purple-900/20 dark:to-purple-900/40 p-4 rounded-lg shadow-sm">
                  <div className="text-sm text-purple-600 dark:text-purple-300 font-medium">Avg. Turnaround Time</div>
                  <div className="text-2xl font-bold text-purple-700 dark:text-purple-200 mt-1">
                    {bestAlgorithm.averageTurnaroundTime.toFixed(2)}
                  </div>
                </div>
                <div className="bg-gradient-to-br from-green-50 to-green-100 dark:from-green-900/20 dark:to-green-900/40 p-4 rounded-lg shadow-sm">
                  <div className="text-sm text-green-600 dark:text-green-300 font-medium">CPU Utilization</div>
                  <div className="text-2xl font-bold text-green-700 dark:text-green-200 mt-1">
                    {(bestAlgorithm.cpuUtilization * 100).toFixed(1)}%
                  </div>
                </div>
                <div className="bg-gradient-to-br from-amber-50 to-amber-100 dark:from-amber-900/20 dark:to-amber-900/40 p-4 rounded-lg shadow-sm">
                  <div className="text-sm text-amber-600 dark:text-amber-300 font-medium">Fairness Index</div>
                  <div className="text-2xl font-bold text-amber-700 dark:text-amber-200 mt-1">
                    {(bestAlgorithm.fairnessIndex * 100).toFixed(1)}%
                  </div>
                </div>
                <div className="bg-gradient-to-br from-pink-50 to-pink-100 dark:from-pink-900/20 dark:to-pink-900/40 p-4 rounded-lg shadow-sm col-span-2 md:col-span-1">
                  <div className="text-sm text-pink-600 dark:text-pink-300 font-medium">Overall Score</div>
                  <div className="text-2xl font-bold text-pink-700 dark:text-pink-200 mt-1">
            ...
            <div className="grid md:grid-cols-2 gap-6">
              ...
              <div className="bg-white dark:bg-gray-800 p-5 rounded-lg border border-gray-100 dark:border-gray-700 shadow-sm">
                <h3 className="text-lg font-semibold mb-3 flex items-center text-amber-700 dark:text-amber-300">
            ...
            <div>
              <h3 className="text-lg font-semibold mb-3 text-blue-700 dark:text-blue-300">Real-World Applications</h3>
              <div className="flex flex-wrap gap-2">
                {verdict.realWorldUses.map((use, index) => (
                  <Badge
                    key={index}
                    className="bg-gradient-to-r from-blue-500 to-purple-500 hover:from-blue-600 hover:to-purple-600 text-white border-none px-3 py-1"
                  >
                    {use}
                  </Badge>
                ))}
            ...
            <div className="bg-gradient-to-r from-blue-50 to-purple-50 dark:from-blue-900/20 dark:to-purple-900/20 p-6 rounded-lg mt-2 border border-blue-100 dark:border-blue-900/30 shadow-sm">
              <h3 className="text-xl font-semibold mb-3 text-blue-700 dark:text-blue-300">Final Recommendation</h3>
